            ...
            @if ($loop->iteration <= $imageToDisplay)
                ...
                @if(!$flexGallery)
                    ...
                    @if(count($images) >= 5)
                        ...
                        @else
                            col-span-6 row-span-6 md:col-span-4 md:row-span-4
                        @endif
                ...
                @endif
                   ...
                   data-glightbox="{{ addslashes($image->title) }}">
                    ...
                    @endif
                    <img
                        class="{{$flexGallery ? 'md:max-h-[500px]' : 'aspect-video'}} relative object-cover w-full h-full cursor-pointer"
                        ...
                        srcset="
                                    ...
                                    "
                        @else
                            sizes="(max-width: 768px) calc((100vw - 48px) / 2), (max-width: 1024px) calc((100vw - 80px) / .5), 257px"
                        srcset="
                                        {{ asset('storage/' . $image->src ) }}?height=94&aspect_ratio=16:9 380w,
                                        {{ asset('storage/' . $image->src ) }}?height=122&aspect_ratio=16:9 480w,
                                        {{ asset('storage/' . $image->src ) }}?height=167&aspect_ratio=16:9 640w,
                                        {{ asset('storage/' . $image->src ) }}?height=202&aspect_ratio=16:9 768w,
                                        {{ asset('storage/' . $image->src ) }}?height=174&aspect_ratio=16:9 1024w,
                                        {{ asset('storage/' . $image->src ) }}?height=145&aspect_ratio=16:9 1025w,
                                    "
                        @endif
                        @endif
                        ...
                        srcset="
                                    ...
                                    "
                        @else
                            sizes="(max-width: 768px) calc(100vw - 48px / 2), (max-width: 1024px) calc((100vw - 96px) / 3), 257px"
                        srcset="
                                        {{ asset('storage/' . $image->src ) }}?height=93&aspect_ratio=16:9 380w,
                                        {{ asset('storage/' . $image->src ) }}?height=121&aspect_ratio=16:9 480w,
                                        {{ asset('storage/' . $image->src ) }}?height=167&aspect_ratio=16:9 640w,
                                        {{ asset('storage/' . $image->src ) }}?height=202&aspect_ratio=16:9 768w,
                                        {{ asset('storage/' . $image->src ) }}?height=173&aspect_ratio=16:9 1024w,
                                        {{ asset('storage/' . $image->src ) }}?height=145&aspect_ratio=16:9 1025w,
                                    "
                        @endif
